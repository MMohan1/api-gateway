...
def run_with_builtin(
        port: int, debug_mode: bool, config_file: str
) -> NoReturn:
    """
...
def main() -> NoReturn:
    ...
    parser.add_option("-c", "--config", dest="config_filename", default="config.yml",
                      help="config file name", metavar="FILE")
    parser.add_option('--debug', help='When passed, sets app in debug mode',
                      dest="debug_mode", action="store_true", default=False)
    parser.add_option('-p', '--port',dest="app_port", type="int", default=5000,
